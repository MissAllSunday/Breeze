...
class Breeze
{
	...
	public static function who($return = false)
	{
		...
		if ($return)
			return '<div style="margin:auto; text-align:center" class="clear"><a href="//missallsunday.com" title="Free SMF Mods">Breeze mod &copy Suki</a></div>';

		elseif (!$return && isset($context['current_action']) && $context['current_action'] === 'credits')
			$context['copyrights']['mods'][] = '<a href="//missallsunday.com" title="Free SMF Mods">Breeze mod &copy Suki</a>';
	}
