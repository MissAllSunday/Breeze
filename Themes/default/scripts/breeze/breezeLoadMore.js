...
breezeLoadMore.prototype.showMoarButton()
{
	// Don't show anything if there isn't enough items to display... this actually should never happen but better be safe...
	...
	}).appendTo(this.options.button.appendTo);
}

breezeLoadMore.prototype.clickButton()
{
...
breezeLoadMore.prototype.onSuccess(html)
{
