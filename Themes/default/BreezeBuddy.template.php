			...
			foreach($context['Breeze']['Buddy_Request'] as $request)
			{
				echo '
						<tr class="windowbg" style="text-align: center">
							...
							<td>
							<a href="', $scripturl ,'?action=profile;area=breezebuddies;from=', $request['user'] ,';noti=', $request['id'] ,';message=confirm" target="_self">', $txt['Breeze_buddyrequest_list_confirm'] ,'</a>
							</td>
							<td>
							<a href="', $scripturl ,'?action=profile;area=breezebuddies;from=', $request['user'] ,';noti=', $request['id'] ,';message=decline" target="_self">', $txt['Breeze_buddyrequest_list_decline'] ,'</a>
							</td>
						</tr>';
			}
