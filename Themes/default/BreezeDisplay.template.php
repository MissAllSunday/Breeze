			...
			<div class="breeze_user_inner">
				...
				<div class="breeze_user_status_comment">
					...
					if ($this->permissions['deleteStatus'])
						$return .= '| <a href="javascript:void(0)" id="'. $this->params['id'] .'" class="breeze_delete_status">'. $this->text->getText('general_delete') .'</a>';

					$return .= '</div>
					<hr />
					<div id="comment_flash_'. $this->params['id'] .'"></div>';

					$return .= '<ul class="breeze_comments_list" id="comment_loadplace_'. $this->params['id'] .'">';
