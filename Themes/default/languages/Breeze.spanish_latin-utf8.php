...
$txt['Breeze_user_settings_load_more_sub'] = 'Al activar esta opción podrás reemplazar la paginación normal por una basada en AJAX, al dar clic en el botón se mostrarán los siguientes mensajes sin necesidad de cambiar de página.';
...
$txt['Breeze_user_settings_cover_select'] = 'Subir imágen de portada';
$txt['Breeze_user_settings_cover_select_sub'] = 'Puedes subir una imágen para que aparezca como portada de tu muro, las medidas recomendadas son 800 x 300 y los tipos de archivo soportados son jpg, png y gif, ten en cuenta que si tu archivo gif es animado, la animación se perdera al guardar la imágen.';
$txt['Breeze_user_settings_cover_done'] = 'Has guardado tu imágen con exito';
$txt['Breeze_user_settings_cover_deleted'] = 'Tu imágen de portada ha sido borrada.';
$txt['Breeze_user_settings_cover_delete'] = 'Borrar tu actual imágen de portada';
...
$txt['Breeze_user_settings_clear_noti_sub'] = 'Las notificaciones sólo serán cerradas cuando vayas a otra página volverán a aparecer hasta que las marques como leídas o las borres, si dejas esta opción vacia las notificaciones nunca se cerrarán y deberás de cerrarlas manualmente.';
...
$txt['Breeze_user_settings_noti_on_comment_owner'] = 'Notifícame cuando alguien escriba un nuevo comentario en algún mensaje en mi muro.';
$txt['Breeze_user_settings_noti_on_comment_owner_sub'] = 'Sólo funciona cuando el mensaje fué escrito por alguien más. Si tu creaste el mensaje, recibirás una notificación distinta.';
...
$txt['Breeze_user_settings_how_many_visitors_sub'] = 'Si se deja vacio se usará el valor por defecto.';
...
$txt['permissionname_breeze_canCover'] = 'Poder subir una imágen de portada <br /><span class="smalltext">  La opción principal debe de estar activada primero.</span>';
...
$txt['Breeze_noti_posted_wall'] = '%1$s <a href="%2$s" class="bbc_link" target="_blank">escribió un nuevo mensaje en tu muro</a>';
