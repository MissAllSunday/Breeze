...
$txt['Breeze_likes_sub'] = 'Tus usuarios podrán usar la función en cualquier status o comentario y si los usuarios tienen activadas sus preferencias de alertas, recibirán una alerta cada vez que alguien le guste un comentario o estatus.<br /> La opción de dar likes debe de estar activada y los usuarios deben de poder dar likes a cualquier contenido (permisos)';
$txt['Breeze_mood'] = 'Activar la opción "mi estado"';
$txt['Breeze_mood_sub'] = 'El usuario tiene que tener JavaScript activado en su navegador para que esta opción funcione.';
...
$txt['Breeze_cover'] = 'Activar la opción de imágen de portada';
$txt['Breeze_cover_sub'] = 'Tus usuarios podrás subir una imágen que aparecerá en sus propios muros, existe un permiso específico para poder subir imágenes así que asegúrate de darles a tus usuarios este permiso.';
