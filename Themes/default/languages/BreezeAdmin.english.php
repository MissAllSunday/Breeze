...
$txt['Breeze_alerts'] = 'Enable notifications';
$txt['Breeze_alerts_sub'] = 'If enable the mod will use SMF\'s alert system to show alerts for the different actions the mod performs. Your users still need to enable their alerts from their profile page.';
...
$txt['Breeze_cover_max_image_size_sub'] = 'In Kb, if no size is given, the mod will use the default value: 80.';
