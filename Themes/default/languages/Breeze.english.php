...
$txt['Breeze_admin_posts_for_mention_sub'] = 'To avoid having a huge list of users to chose from when mentioning, you can set how many posts does an user needs to have in order to be mentionable, if you leave this setting empty, it will use the default value: 1';
