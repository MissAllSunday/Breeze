...
$txt['Breeze_user_settings_desc'] = 'From this page you will be able to setup the different settings for your wall.';
...
$txt['Breeze_user_settings_visitors_timeframe_hour'] = 'Hour';
$txt['Breeze_user_settings_visitors_timeframe_day'] = 'Day';
...
// Admin Settings
$txt['Breeze__admin_panel'] = 'Breeze Admin Panel';
...
$txt['Breeze__main'] = 'Main Breeze Admin Center';
$txt['Breeze__sub_permissions'] = 'Permissions';
$txt['Breeze__sub_style'] = 'Style and Layout';
$txt['Breeze__sub_style_desc'] = 'Some description here';
$txt['Breeze__settings'] = 'General Settings';
$txt['Breeze__settings_desc'] = 'This is the general settings page, from here you can enable/disable the mod as well as configuring general settings.';
$txt['Breeze__permissions'] = 'Permissions';
$txt['Breeze__permissions_desc'] = 'From here you can add/remove specific Breeze permissions.';
$txt['Breeze__donate'] = 'Donate';
$txt['Breeze__donate_desc'] = 'Boring stuff you had curious about it but you\'ll never gonna see it again :P';
$txt['Breeze__server_needs'] = '<div class="breeze_error_message">Your Server does not support %s, contact your hosting provider and ask for it to be enable, otherwise you won\'t be able to use this mod at full.</div>';
$txt['Breeze__json'] = 'JSON library';
$txt['Breeze__php'] = '<div class="breeze_error_message">Your PHP version: ( %s ) is lower than the minimum required by this mod: 5.3, you won\'t be able to use this mod at full.</div>';
$txt['Breeze__php_ok'] = '<div class="breeze_ok_message">Your PHP version is supported.</div>';
$txt['Breeze__server_needs_ok'] = '<div class="breeze_ok_message"> %s is supported by your server.</div>';
$txt['Breeze__tab_server_specs'] = 'Server Requirements';
$txt['Breeze__tab_admin_logs'] = 'Admin Logs';
$txt['Breeze__donate'] = 'Donate';
...
$txt['Breeze__enablegeneralwall'] = 'Enable General Wall';
$txt['Breeze__enablegeneralwall_sub'] = 'If enable, a general wall will appear, in this general wall the user will be able to see his/her buddie\'s status and recent activity';
$txt['Breeze__menuposition'] = 'Select the position for the general Wall button.';
$txt['Breeze__menuposition_sub'] = 'By default is next to the home button.';
$txt['Breeze__enable'] = 'Enable Breeze mod';
$txt['Breeze__sub'] = 'The master setting, this must be enable for the mod to work properly.';
$txt['Breeze__force_enable'] = 'Check to force the enabling of walls.';
$txt['Breeze__force_enable_sub'] = 'By default the wall is disable and users needs to enable it manually, if you check this option their wall will be enable, keep in mind this option will enable everyone\'s wall including inactive members and bots.<br /> They can still manually disable their wall if they want it, this option only enables it but does not really forces the wall to be always enable.';
$txt['Breeze__force_enable_on'] = 'Enable';
$txt['Breeze__force_enable_off'] = 'Disable';
$txt['Breeze__home'] = 'Home';
$txt['Breeze__help'] = 'Help';
$txt['Breeze__profile'] = 'Profile';
