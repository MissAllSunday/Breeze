...
$txt['Breeze_admin_settings_force_enable'] = 'Enable the wall for everyone.';
$txt['Breeze_admin_settings_force_enable_sub'] = 'By default the wall is disable and users needs to enable it manually, if you check this option their wall will be enable, keep in mind this option will enable everyone\'s wall including inactive members, bots and other pseudo-users.';
