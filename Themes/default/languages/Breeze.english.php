...
$txt['Breeze_user_settings_select_file'] = 'Cover image file';
$txt['Breeze_user_settings_select_file_sub'] = 'Some description here';
$txt['Breeze_user_settings_select_file_done'] = 'Your image was successfully uploaded';
...
$txt['Breeze_user_settings_noti_on_status'] = 'Notify me when someone post a new status on my wall';
$txt['Breeze_user_settings_noti_on_status_sub'] = 'Any user capable of posting new status on your own wall.';
...
$txt['Breeze_user_settings_noti_on_comment_owner'] = 'Notify me when someone made a comment on an status made on my wall';
$txt['Breeze_user_settings_noti_on_comment_owner_sub'] = 'This only works if the status was made by someone else and it was made on your wall, if you made the status you will get receive the "someone comments on my status" notification.';
