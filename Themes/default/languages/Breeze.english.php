...
$txt['Breeze_user_settings_paginationNumber_desc'] = 'Enter the number of status you want to display per page on your wall. By default is 5';
$txt['Breeze_user_settings_generalWall'] = 'Enable the general wall';
$txt['Breeze_user_settings_generalWall_desc'] = 'The general wall is a unique page where you can see the status and updates from your buddies. This setting allows you to enable/disable it.';
...
$txt['Breeze_user_settings_wall_desc'] = 'If you want to use your wall, you need to check this option, otherwise your profile will show the default page.';
...
$txt['Breeze_user_settings_kickIgnored_desc'] = 'If this is enable, users on your ignore list will not be able to see your wall or to post on it.';
