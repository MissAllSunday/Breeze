...
$txt['Breeze_admin_settings_sub'] = 'The master setting, this must be enable for the mod to work properly.';
$txt['Breeze_admin_settings_force_enable'] = 'Check to force the enabling of walls.';
$txt['Breeze_admin_settings_force_enable_sub'] = 'By default the wall is disable and users needs to enable it manually, if you check this option their wall will be enable, keep in mind this option will enable everyone\'s wall including inactive members and bots.<br /> They can still manually disable their wall if they want it, this option only enables it but does not really forces the wall to be always enable.';
$txt['Breeze_admin_settings_force_enable_on'] = 'Enable';
$txt['Breeze_admin_settings_force_enable_off'] = 'Disable';
...
$txt['permissionname_breeze_deleteStatus'] = 'Delete all status on any wall';
$txt['permissionname_breeze_deleteOwnStatus'] = 'Delete their own status.<br /> Regardless of where it has been posted.';
$txt['permissionname_breeze_deleteOwnComments'] = 'Delete their own comments.<br /> Regardless of where it has been posted.';
$txt['permissionname_breeze_deleteProfileStatus'] = 'Delete status made on their own profile.<br /> Regardless of who posted them.';
$txt['permissionname_breeze_deleteProfileComments'] = 'Delete status made on their own profile.<br /> Regardless of who posted them.';
...
$txt['Breeze_success_delete_comment'] = 'Your comment has been deleted';
