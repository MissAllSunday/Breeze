...
$txt['Breeze_user_settings_how_many_buddies_sub'] = 'Por defecto se muestran los primeros 10, el m&aacute;ximo de amigos que se pueden mostrar es 30.';
...
$txt['Breeze_user_settings_how_many_visitors_sub'] = 'Si se deja vacio se usar&aacute; el valor por defecto 10, el m&aacute;ximo de usuarios a mostrar es 30.';
...
$txt['Breeze_noti_posted_wall'] = '%1$s escribi&oacute; un nuevo mensaje en tu muro: %2$s';

// Someone commented your status on your own wall
$txt['Breeze_noti_posted_comment'] = '%1$s coment&oacute; en tu status: %2$s en el muro de %3$s';
