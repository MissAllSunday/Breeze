...
$txt['Breeze_likes_sub'] = 'Your users will be able to like any status or comments and if the user has the respective alert enable, will receive an alert whyen someone likes their status/comments';
