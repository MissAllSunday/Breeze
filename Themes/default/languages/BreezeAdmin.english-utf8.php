...
$txt['Breeze_cover_sub'] = 'Your users will be able to upload an image to serve as a cover on their own wall, there is a separate permission for this so be sure to enable this feature and then give the appropiate permissions for your users.';
